...
# Memperbarui VECTORIZER_PATH kembali ke 'tfidf_vectorizer.pkl'
VECTORIZER_PATH = 'tfidf_vectorizer.pkl' 
DATA_PATH = 'https://github.com/Yudistira479/novel/blob/main/novels.csv' 


# --- Fungsi Pemuatan Data dan Model (dengan caching untuk performa) ---

@st.cache_data
def load_data(source_url): # Mengubah parameter menjadi source_url
    """Memuat dataset novel dari URL GitHub."""
    try:
        # Membaca dari URL GitHub
